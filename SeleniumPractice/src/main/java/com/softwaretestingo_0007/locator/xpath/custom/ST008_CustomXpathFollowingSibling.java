...
public class ST008_CustomXpathFollowingSibling 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//label[contains(text(),'First')]/following-sibling::input[1]")).sendKeys("SoftwareTestingo");
		Thread.sleep(3000);
		driver.quit();		
	}
}