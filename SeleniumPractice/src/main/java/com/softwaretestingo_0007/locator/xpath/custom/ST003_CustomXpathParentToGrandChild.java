...
public class ST003_CustomXpathParentToGrandChild 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(3000);
		String lblText = driver.findElement(By.xpath("(//div[@id='post-body-1369437471207238134']/form/label)[position()=1]")).getText();
