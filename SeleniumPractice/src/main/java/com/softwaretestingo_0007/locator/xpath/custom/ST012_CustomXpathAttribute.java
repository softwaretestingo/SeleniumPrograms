...
public class ST012_CustomXpathAttribute 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		String lblLastname=driver.findElement(By.xpath("//label[attribute::for='lname']")).getText();
		System.out.println("The Text is: "+lblLastname);
		driver.quit();
	}
}